...
class unreadNotifyExtension extends \Twig_Extension
{
    ...
    {
        return array(
            "unreadNotify" => new \Twig_Function_Method($this, "renderUnreadNotify", array("is_safe" => array("html"))),
        );
    }
    ...
    public function renderUnreadNotify(array $options = array())
    {
        ...
        return $this->container->get('templating')->render("AppBundle:Block:unreadNotify.html.twig", ["count"=>$count]);
