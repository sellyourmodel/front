...
class unreadMessageExtension extends \Twig_Extension
{
    ...
    {
        return array(
            "unreadMessage" => new \Twig_Function_Method($this, "renderUnreadMessage", array("is_safe" => array("html"))),
        );
    }
    ...
    public function renderUnreadMessage(array $options = array())
    {
        ...
        return $this->container->get('templating')->render("AppBundle:Block:unreadMessage.html.twig", ["count"=>$count]);
