...
class SubscribeController extends Controller
{
    ...
    public function subscribeAction(Request $request)
    {
        ...
        $subscribe = $em->getRepository('AppBundle:Subscribe')->findOneBy(["email"=>$email]);
    ...
    public function subscribeRemoveAction(Request $request)
    {
        ...
        $subscribe = $em->getRepository('AppBundle:Subscribe')->findOneBy(["code"=>$code]);
    ...
    public function subscribeRemoveWriteAction(Request $request)
    {
        ...
        $couponExist = $em->getRepository('AppBundle:Coupon')->findOneBy(["number"=>$couponNumber]);
