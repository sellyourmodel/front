...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($users as $user){
            $modelsModerated = count($em->getRepository('AppBundle:Product')->findBy(["user"=>$user, "moderated"=>true]));
            $modelsNoModerated = count($em->getRepository('AppBundle:Product')->findBy(["user"=>$user, "moderated"=>false]));
