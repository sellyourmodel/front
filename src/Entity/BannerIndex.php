...
class BannerIndex
{
     ...
     * Set icon
     *
     * @param \App\Application\Sonata\MediaBundle\Entity\Media $icon
     *
     * @return BannerIndex
     */
    public function setIcon(\App\Application\Sonata\MediaBundle\Entity\Media $icon = null)
    {
        $this->icon = $icon;
     ...
     * Set bg
     *
     * @param \App\Application\Sonata\MediaBundle\Entity\Media $bg
     *
     * @return BannerIndex
     */
    public function setBg(\App\Application\Sonata\MediaBundle\Entity\Media $bg = null)
    {
        $this->bg = $bg;
